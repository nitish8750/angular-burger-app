...
export class AuthService {
    ...
    signUp(email: string, password: string){
        ...
        ('https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=' + environment.firebaseAuthKey, 
            {
                email,
                password,
    ...
    login(email: string, password: string){
        return this.http.post<AuthResponseData>
        ('https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=' + environment.firebaseAuthKey, 
            {
                email,
                password,
                returnSecureToken: true
